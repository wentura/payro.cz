      ...
      <div className="space-y-6 w-full mx-auto">
        ...
        <div className="flex justify-between text-center md:text-left max-w-7xl mx-auto">
          <div className="mx-auto md:mx-0 max-w-7xl">
            <h1 className="text-3xl font-semibold tracking-tight text-fktr-fg mx-auto">
              Zrušené faktury
            </h1>
        ...
        <Card>
          {invoices.length === 0 ? (
            ...
            <div className="overflow-x-auto max-w-full mx-auto">
              <table className="min-w-full divide-y divide-fktr-border max-w-7xl mx-auto">
                <thead>
                  <tr>
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 gap-6">
            <Card>
              <div className="text-center">
                <div className="text-3xl font-bold text-fktr-muted">
                  {invoices.length}
                </div>
